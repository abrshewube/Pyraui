defmodule AshuiWeb.LandingLive do
  ...
  def mount(_params, _session, socket) do
    ...
    component_gallery = [
      ...
      %{
        ...
        code: """
        <Ashui.Components.Gantt.gantt tasks={tasks} />
        <Ashui.Components.LiveDataTable.live_data_table rows={rows} />
        """
      },
      %{
        category: "Navigation",
    ...
    testimonials = [
      %{
        quote:
          "AshUI made our Phoenix LiveView dashboard feel like a polished SaaS in a weekend. The component API is incredibly intuitive.",
        author: "Marina Chen",
      ...
      %{
        quote:
          "Performance is incredible. Our dashboard loads 3x faster with AshUI compared to our previous custom solution.",
        author: "Sophie Zhang",
    ...
    install_commands = [
      ...
      %{label: "Add to mix.exs", cmd: "{:ashui, \"~> 0.1.0\"}", icon: "hero-cog"},
      %{
        label: "Import components",
        cmd: "import Ashui.Components.{Button, Input}",
    ...
    defmodule MyAppWeb.HelloLive do
      ...
      import Ashui.Components.{Button, Card, Input}
        ...
        <Layouts.app flash={@flash}>
          <div class=\"p-10 space-y-8\">
            <Card.card class=\"max-w-md\">
              <Card.card_header>
                <Card.card_title>Welcome to AshUI</Card.card_title>
          ...
          <div class="mx-auto grid max-w-7xl items-center gap-20 lg:grid-cols-2">
            <div class="text-slate-100 relative">
              ...
              <div class="inline-flex items-center gap-3 rounded-2xl border border-white/10 bg-gradient-to-r from-blue-500/10 to-purple-500/10 px-6 py-3 text-sm font-semibold uppercase tracking-wide text-blue-200 backdrop-blur-sm shadow-lg shadow-blue-500/10 mb-8 animate-pulse">
                ...
                <span>Introducing AshUI 1.0</span>
              </div>
            ...
            <div class="grid gap-16 lg:grid-cols-2">
              ...
              <div>
                ...
                <p class="mt-6 text-lg text-slate-300">
                  See how AshUI components respond instantly to user interactions with buttery-smooth animations and real-time updates.
                </p>
              ...
              <div class="relative w-full max-w-2xl rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 to-slate-800 p-8 shadow-2xl shadow-blue-500/20 animate-in zoom-in duration-300">
                ...
                <div class="relative z-10">
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div>
                      <h3 class="text-2xl font-semibold text-white">Experience AshUI in action</h3>
                      <p class="mt-2 text-slate-300">
                        This modal showcases the smooth animations and premium feel you get with every AshUI component.
                      </p>
                    </div>
                  </div>
          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-12 relative">
            <div class="grid gap-16 lg:grid-cols-2">
              <div>
                ...
                <p class="mt-6 text-lg text-slate-300">
                  Add AshUI to your Phoenix project and start building beautiful interfaces immediately.
                </p>
        ...
        <footer class="relative bg-slate-950/95 py-16 text-slate-300 border-t border-white/10">
          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-12">
            ...
            <div class="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-slate-500">
              <p>Copyright © 2025 AshUI. All rights reserved.</p>
